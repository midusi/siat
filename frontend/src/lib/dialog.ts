...
export function showAlert(opts: Omit<Partial<AlertDialogState>, 'type' | 'resolve'> & { message: string }): Promise<void> {
...
export function showConfirm(opts: Omit<Partial<ConfirmDialogState>, 'type' | 'resolve'> & { message: string }): Promise<boolean> {
