...
export const TaskFormSchema = z.object({
	...
	selectedProvince: z
		.number()
		.nullable()
		.refine((val) => val !== null, { message: 'Seleccione una provincia' }),
	selectedDistrict: z
		.number()
		.nullable()
		.refine((val) => val !== null, { message: 'Seleccione un distrito' }),
	selectedLocality: z
		.number()
		.nullable()
		.refine((val) => val !== null, { message: 'Seleccione una localidad' }),
	file: z
